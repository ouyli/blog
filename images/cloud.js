...
function init()
{
    ...
    container.style.cssText = "position:absolute;left:0; top:0;z-index:0;";
    ...
    var fog = new THREE.Fog(0xFFFFFF, 100, 800);
    ...
    for (i = 0; i < 8000; i++) {
        ...
        plane.position.y = Math.random() * Math.random() * 2000 - 15;
        plane.position.z = i;
...
function render() {
    position = ((new Date().getTime() - start_time) * 0.01) % 8000;
